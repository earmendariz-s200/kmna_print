          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="pull-right col-sm-2">
                <a class="btn btn-success" href="javascript:;" onclick="agregar();"><i class="fa fa-plus"></i> Registrar Proveedor</a>
              </div>
            </div>
...
<div class="modal fade text-left" id="modalProveedor" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Regristro de Proveedor</h4>
      ...
      <div class="modal-body">
        ...
        <div class="row" style="margin-top: 10px;">
          ...
          <div class="col-sm-2">
            <label>Num. Ext.</label>
            <input type="text" id="txtNumExterior" class="form-control">
          </div>
          <div class="col-sm-2">
            <label>Num. Int.</label>
            <input type="text" id="txtNumInterior" class="form-control">
          </div>
        </div>
        <div class="row">
          <div class="col-sm-3">
...
<?php include realpath($_SERVER["DOCUMENT_ROOT"]).$_SESSION["DIR_LOCAL"]."/vws/footer.php"; ?>
  ...
  <script type="text/javascript" src="<?php echo $URL_PRINCIPAL; ?>core/js/almacen/proveedores.js"></script>