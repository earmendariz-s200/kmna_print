          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="pull-right col-sm-2">
                <a class="btn btn-success" href="javascript:;" onclick="agregar();"><i class="fa fa-plus"></i> Registrar Nuevo color</a>
              </div>
            </div>
            <div class="card-content">
              <div class="card-body">
                <table class="table table-striped table-bordered" id="tablaColores">
                  <thead>
                    <tr>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Regristro de colores</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <input type="hidden" id="hdColoresId" value="0">
        <div class="row">
          <div class="col-sm-8">
            <label>Nombre:</label>
...
<?php include realpath($_SERVER["DOCUMENT_ROOT"]).$_SESSION["DIR_LOCAL"]."/vws/footer.php"; ?>
  ...
  <script type="text/javascript" src="<?php echo $URL_PRINCIPAL; ?>core/js/catalogos/colores.js"></script>
