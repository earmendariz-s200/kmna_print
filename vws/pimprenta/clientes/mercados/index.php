          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="pull-right col-sm-2">
                <a class="btn btn-success" href="javascript:;" onclick="agregar();"><i class="fa fa-plus"></i> Registrar nuevo mercado</a>
              </div>
            </div>
            <div class="card-content">
              <div class="card-body">
                <table class="table table-striped table-bordered" id="tablaMercados">
                  <thead>
                    <tr>
                      <th style="width: 25%;">Mercado</th>
...
<div class="modal fade text-left" id="modalMercados" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Regristro de Mercados</h4>
...
<?php include realpath($_SERVER["DOCUMENT_ROOT"]).$_SESSION["DIR_LOCAL"]."/vws/footer.php"; ?>
  ...
  <script type="text/javascript" src="<?php echo $URL_PRINCIPAL; ?>core/js/clientes/mercados.js"></script>