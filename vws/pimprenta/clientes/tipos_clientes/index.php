        ...
        <div class="col-xl-12 col-lg-12">
          <div class="card">
            <div class="card-header">
              <div class="col-sm-10">
                <h3 class="card-title">Tipo de clientes</h3>
            ...
            <div class="card-content">
              <div class="card-body">
                <table class="table table-striped table-bordered" id="tablaTipoClientes">
                  <thead>
                    <tr>
                      <th style="width: 25%;">Tipo de cliente</th>
                      <th style="width: 50%;">Descrición</th>
...
<?php include realpath($_SERVER["DOCUMENT_ROOT"]).$_SESSION["DIR_LOCAL"]."/vws/footer.php"; ?>
  ...
  <script type="text/javascript" src="<?php echo $URL_PRINCIPAL; ?>core/js/clientes/tipo_cliente.js"></script>