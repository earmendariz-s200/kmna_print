              ...
              <div class="card-body" style="margin-top: -30px;">
                <div class="row">
                  ...
                  <div class="col-sm-2">
                    ...
                    <input type="date" name="txtValidaHasta" id="txtValidaHasta" class="form-control" value="<?php echo date("Y-m-d", strtotime("+ 5 days ", strtotime("NOW"))); ?>">
                  </div>
                </div>
                <div class="row" style="margin-top: 15px;">
                  <div class="col-sm-3">
                    <label>Cliente:</label>
                    <select class="form-control" id="cbClientes" name="cbClientes" onchange="get_contactos();">
                    </select>
                  </div>
...
<div class="modal fade text-left" id="modalDetalle" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document" style="min-width: 75%">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-sm-2">
            ...
            <select class="form-control" id="cbTipoProductoDetalle" name="cbTipoProductoDetalle" onchange="get_tipodiseno();" style="width: 100%;">
            </select>
          </div>
          <div class="col-sm-2">
            <label>Tag:</label>
          ...
          <div class="col-sm-2">
            ...
            <input type="number" name="txtCantidadDetalle" name="txtCantidadDetalle" class="form-control" value="1" >
          </div>
          <div class="col-sm-3">
            <label>Trabajo:</label>
            <select id="cbTipoTrabajoDetalle" class="form-control">
              <option value="0">Sangrado</option>
              <option value="0">Con margen blanco</option>
            </select>
          </div>
          <div class="col-sm-2">
            ...
            <div class="tab-content px-1 pt-1" style="min-height: 50px;;">
              <div role="tabpanel" class="tab-pane active" id="tab1_1" aria-expanded="true" aria-labelledby="base-tab1_1" >
                <div class="row">
                  <div class="col-sm-3">
                    <label>Medida:</label>
                    <select id="cbMedida1" class="form-control">
                  ...
                  <div class="col-sm-3 div_medida1_estandar">
                    ...
                    <select class="form-control" id="cbTamanoPapel1Detalle">
                    </select>
                  </div>
                ...
                <div class="row" id="div_diseño2" style="display: none; margin-top: 20px;">
                  <div class="col-sm-3">
                    <label>Medida:</label>
                    <select id="cbMedida2" class="form-control">
                      <option value="0">Estandar</option>
                      <option value="1">Personalizado</option>
                    </select>
                  </div>
                  <div class="col-sm-3 div_medida2_estandar">
                    <label>Estandar:</label>
                    <select class="form-control" id="cbTamanoPapel2Detalle">
                    </select>
                  </div>
                ...
                <div class="row" style="margin-top: 20px;">
                  <div class="col-sm-3">
                    ...
                    <select class="form-control" id="cbOrientacionDetalle">
              ...
              <div class="tab-pane" id="tab1_2" aria-labelledby="base-tab1_2">
                ...
                <div class="row" id="div-diseno2" style="display: none;">
                  <div class="col-sm-3">
                    ...
                    <select id="cbDiseno2Utiliza" class="form-control">
                  ...
                  <div class="col-sm-1">
                    <label>Paginas: </label>
                    <input type="number" id="txtDiseno2Paginas" class="form-control" value="1" min="1" step="1">
                  </div>
                  <div class="col-sm-2">
                    <label>Medida como: </label>
                    <select class="form-control" id="cbDiseno2MedidaComo">
                ...
                <div class="row" style="margin-top: 15px; margin-bottom: 35px;">
                  <div class="col-sm-4">
                    ...
                    <select class="form-control" id="cbTipoPapelDiseno">
                    </select>
                  </div>
                  <div class="col-sm-2">
                    <label>Gramaje:</label>
                    <select class="form-control" id="cbGramajeDiseno"></select>
                  </div>
                  <div class="col-sm-2">
                    <label>Tintas frente:</label>
                    <select class="form-control" id="cbTintasFrenteDiseno"></select>
                  </div>
                  <div class="col-sm-2">
                    <label>Tintas vuelta:</label>
                    <select class="form-control" id="cbTintasVueltaDiseno"></select>
                  </div>
                  <div class="col-sm-2" style="margin-top: 20px;">
              ...
              <div class="tab-pane" id="tab1_3" aria-labelledby="base-tab1_3">
                <div class="row">
                  <div class="col-sm-3">
                    ...
                    <select id="cbMaterialesAcabados" class="form-control" onchange="cargar_combo_materiales();"></select>
                  </div>
                  <div class="col-sm-9">
      ...
      <div class="modal-footer">
        <textarea class="form-control" cols="6" rows="4" id="txtDetalleCotizacion" disabled="disabled"></textarea>
