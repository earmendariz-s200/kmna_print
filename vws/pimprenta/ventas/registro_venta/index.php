              ...
              <div class="card-body" style="margin-top: -30px;">
                <div class="row">
                  ...
                  <div class="col-sm-2">
                    ...
                    <input type="date" name="txtValidaHasta" id="txtValidaHasta" class="form-control" value="<?php echo date("Y-m-d", strtotime("+ 1 month ", strtotime("NOW"))); ?>">
                  </div>
                </div>
                <div class="row" style="margin-top: 15px;">
                  ...
                  <div class="col-sm-1" style="margin-top: 30px;">
                    <a href="<?php echo $_SESSION["DIR_LOCAL"]?>/vws/pimprenta/clientes/registro/cliente.php" class="btn btn-success hidden" id="agregarContacto" target="_blank"><i class="fa fa-plus"></i></a>
                  ...
                  <div class="col-sm-3">
                    ...
                    <select class="form-control" id="cbVendedor" name="cbVendedor">
                      <option value="0">[Seleccione Asesor]</option></select>
                  </div>
                </div>
                <div class="row" style="margin-top: 15px;">
                  <div class="col-sm-3">
              ...
              <div role="tabpanel" class="tab-pane active" id="tab1_1" aria-expanded="true" aria-labelledby="base-tab1_1" >
                ...
                <div class="row" id="div_diseño2" style="display: none; margin-top: 20px;">
                  ...
                  <div class="col-sm-3 div_medida2_personalizado" style="display: none;">
                    <label>Ancho:</label>
                    <input type="number" id="txtAncho2" class="form-control" value="0" min="0" >
                  </div>
                  <div class="col-sm-3 div_medida2_personalizado" style="display: none;">
                    <label>Alto:</label>
                    <input type="number" id="txtAlto2" class="form-control" value="0" min="0" >
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="row">
                      ...
                      <div class="col-sm-4 medidas hiddden">
                        <label>Ancho:</label>
                  ...
                  <div class="col-sm-3">
                    ...
                    <input type="hiddden" class="form-control" name="txtIdentificarMaterial" id="txtIdentificarMaterial" />
                  </div>
                </div>
                <br />
