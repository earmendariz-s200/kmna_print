...
get_materiales();
 ...
 $("#btn_guardar").click(function(){
      ...
      if (validaRequeridos("frm_ajuste")) {
          ...
          $("#btn_guardar").prop("disabled",true);
            ...
            var response = sendRequest(window.location.origin+DIR_LOCAL_JS+"/core/ph/almacen/ajustes/set_ajuste.php", data);
...
$('#tablaListado tbody').html("");
    ...
    var response = sendRequest(window.location.origin+DIR_LOCAL_JS+"/core/ph/almacen/ajustes/get_historial.php", data);
    if(response[0].RESULT){
