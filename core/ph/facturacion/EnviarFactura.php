...
$url_img_pdf = "https://demo.status200.mx/sw_carmona/assets/images/pdf.png";
$url_img_xml =  "https://demo.status200.mx/sw_carmona/assets/images/xml.png";
...
try {
    ...
    $to = $to;
    $subject = 'Factura CARMONA IMPRESORES';
    $text = 'Factura CARMONA IMPRESORES';
    $html = $contentEmail;
    $crlf = "\r\n";
